...
def main():
    ...
    with tab_online:
        ...
        # ----------------------------------------------------
        # ПОЛУЧАЕМ WINDOWS-ПОЛЬЗОВАТЕЛЕЙ
        # ----------------------------------------------------

        online_users_with_accounts = (
            logger.get_online_users_with_accounts(
                minutes=5
            )
        )
        ...
        if online_users_with_accounts:
            ...
            # -----------------------------------------------
            # СТАТУС WINDOWS-СЕССИИ
            # -----------------------------------------------

            df_online["Статус сессии"] = (
                df_online["Статус сессии"]
                .replace({
                    "Активно": "🟢 Активно",
                    "Active": "🟢 Активно",
            ...
            st.warning(
                ...
                "но Windows-пользователей определить не удалось."
            )
